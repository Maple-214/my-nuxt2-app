                              ...
                              <div class="kd-photobox">
                                <div class="photobox-img">
                                  <img
                                    ...
                                    width="500"
                                    height="334"
                                    src="https://img.freepik.com/premium-photo/tour-tourism-background_92505-1026.jpg?ga=GA1.1.1174743762.1702278788&semt=ais_ai_generated"
                                    class="attachment-full"
                                    alt=""
                                    title="African,American,Businessman,Gesturing,During,Discussion,With,Smiling,Multicultural,Business"
                                    srcset="
                                      https://img.freepik.com/premium-photo/tour-tourism-background_92505-1026.jpg?ga=GA1.1.1174743762.1702278788&semt=ais_ai_generated 500w,
                                      https://img.freepik.com/premium-photo/tour-tourism-background_92505-1026.jpg?ga=GA1.1.1174743762.1702278788&semt=ais_ai_generated 300w
                                    "
...
<script>
  ...
  export default {
    head() {
      return {
        title:
          this.$t('business.type4_tile') + '|' + this.$t('SITE_ROOT_TITLE'),
        meta: [
          {
            hid: 'description',
            name: 'description',
    ...
    computed: {
      meta() {
        return {
          title: this.$t('business.type4_tile'),
